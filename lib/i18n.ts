...
const en: Record<string, string> = {
  "site.title": "OpenCard — Credit Card Wiki",
...
const es: Record<string, string> = {
  "site.title": "OpenCard — Wiki de Tarjetas de Crédito",
  ...
  "about.title": "Acerca de OpenCard",
