...
export default async function TermsPage({ params }: Props) {
  ...
  const content = {
    ...
    "zh-cn": {
      title: "服务条款",
      lastUpdated: "最后更新：2026年4月15日",
      sections: [
        {
          heading: "1. 条款接受",
          body: "访问和使用 OpenCard AI 即表示您接受并同意受本协议的条款和条件约束。如果您不同意遵守这些条款，请不要使用本服务。"
        },
        {
          heading: "2. 服务说明",
          body: "OpenCard AI 是一个信用卡比较和推荐平台，提供美国信用卡的信息。我们的 AI 工具可根据用户的消费习惯和偏好帮助他们找到适合的信用卡。"
        },
        {
          heading: "3. 非财务建议",
          body: "OpenCard AI 上的内容（包括 AI 生成的推荐）仅供信息参考。我们不是金融机构、信用顾问或律师事务所。本网站上的任何内容都不构成专业的财务、法律或投资建议。在做出信用决策前，请务必咨询合格的财务专业人士。"
        },
        {
          heading: "4. 信息准确性",
          body: "虽然我们努力保持所有信息的准确性和最新状态，但无法保证所有数据都无错误。信用卡条款、回馈率、年费和开卡奖励可能会有变化。请在申请前向发卡银行核实所有信息。"
        },
        {
          heading: "5. 联盟链接",
          body: "OpenCard AI 包含通往银行网站信用卡申请的链接，并可能从联盟合作伙伴关系中获得报酬。这不会影响我们的推荐或提供的信息。"
        },
        {
          heading: "6. 用户行为",
          body: "您同意仅将本服务用于合法目的，且不以侵犯他人权利的方式使用。您不得使用本服务传输任何有害代码、垃圾邮件或非法内容。"
        },
        {
          heading: "7. 责任限制",
          body: "OpenCard AI 不对因使用本网站信息而做出的任何决定承担责任。用户须对其财务决策承担全部责任。"
        },
        {
          heading: "8. 条款变更",
          body: "我们保留随时修改这些条款的权利。变更将在发布到网站后立即生效。"
        },
        {
          heading: "9. 联系我们",
          body: "如对本服务条款有任何疑问，请通过 support@opencardai.com 与我们联系。"
        }
      ]
    },
    es: {
