...
export default async function HomePage({ params }: Props) {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-6">
      ...
      {/* Card Grid Header */}
      <section id="cards-section" className="mb-4" style={{ scrollMarginTop: "120px" }}>
      </section>
      ...
      <section id="about" className="mt-12 bg-white rounded-xl border border-slate-200 p-6" style={{ scrollMarginTop: "120px" }}>
