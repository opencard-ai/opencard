...
export default async function CardDetailPage({ params }: Props) {
  ...
  const isBiltReferral = referralOffer?.program === "bilt";
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <div className="text-sm font-semibold text-blue-900">
                  {lang === "zh"
                    ? isAmexReferral ? "查看 American Express Referral Offers" : isBiltReferral ? "查看 Bilt Referral Offers" : isChaseMarriottReferral ? "查看 Chase Marriott Referral Offers" : isChaseSapphireReferral ? "查看 Chase Sapphire Referral Offers" : "查看 Chase Freedom Referral Offers"
                    : lang === "zh-cn"
                    ? isAmexReferral ? "查看 American Express Referral Offers" : isBiltReferral ? "查看 Bilt Referral Offers" : isChaseMarriottReferral ? "查看 Chase Marriott Referral Offers" : isChaseSapphireReferral ? "查看 Chase Sapphire Referral Offers" : "查看 Chase Freedom Referral Offers"
                    : lang === "es"
                    ? isAmexReferral ? "Ver ofertas por recomendación de American Express" : isBiltReferral ? "Ver ofertas por recomendación de Bilt" : isChaseMarriottReferral ? "Ver ofertas por recomendación de Chase Marriott" : isChaseSapphireReferral ? "Ver ofertas por recomendación de Chase Sapphire" : "Ver ofertas por recomendación de Chase Freedom"
                    : isAmexReferral ? "View American Express Referral Offers" : isBiltReferral ? "View Bilt Referral Offers" : isChaseMarriottReferral ? "View Chase Marriott Referral Offers" : isChaseSapphireReferral ? "View Chase Sapphire Referral Offers" : "View Chase Freedom Referral Offers"}
                </div>
                <p className="mt-1 text-xs leading-relaxed text-blue-800">
                  {lang === "zh"
                    ? isAmexReferral
                      ...
                      : isBiltReferral
                        ? "此 Bilt invite 頁目前列出 Blue、Obsidian 與 Palladium；請以 Bilt 頁面顯示的即時優惠與資格為準。若您透過此連結獲核准，推薦人可能獲得獎勵；這不影響 OpenCard 的評價。"
                    ...
                    ? isAmexReferral
                      ...
                      : isBiltReferral
                        ? "此 Bilt invite 页面目前列出 Blue、Obsidian 与 Palladium；请以 Bilt 页面显示的实时优惠与资格为准。如果您通过此链接获批，推荐人可能获得奖励；这不影响 OpenCard 的评价。"
                      : isChaseMarriottReferral
                    ...
                    ? isAmexReferral
                      ...
                      : isBiltReferral
                        ? "La página de invitación de Bilt muestra actualmente Blue, Obsidian y Palladium. Confirma allí las ofertas y la elegibilidad vigentes. El referente podría recibir una recompensa si se aprueba tu solicitud; esto no influye en la evaluación de OpenCard."
                      : isChaseMarriottReferral
                    ...
                    : isAmexReferral
                      ...
                      : isBiltReferral
                        ? "The Bilt invite page currently lists Blue, Obsidian, and Palladium. Confirm current offers and eligibility on Bilt. The referrer may receive a reward if you are approved; this does not influence OpenCard's evaluation."
                      : isChaseMarriottReferral
