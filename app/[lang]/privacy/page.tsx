...
export default async function PrivacyPage({ params }: Props) {
  ...
  const c = {
    ...
    "zh-cn": {
      title: "隐私政策",
      lastUpdated: "最后更新：2026年4月18日",
      intro: "OpenCard AI 致力于保护您的隐私。本政策说明我们在您使用信用卡福利管理服务时如何收集、使用及保护您的信息。",
      sections: [
        {
          heading: "1. 我们收集的信息",
        ...
        {
          heading: "4. 双重验证订阅",
          body: "当您订阅时，我们会发送验证邮件确认您的地址。点击验证链接后，订阅才会启用。这能防止未经授权的注册并确保邮件送达。"
        },
        {
          heading: "5. Cookie",
        ...
        {
          heading: "8. 儿童隐私",
          body: "本服务不适用于未满 18 岁的用户。我们不会故意收集未成年人的信息。"
        },
        {
          heading: "9. 政策变更",
          body: "我们可能不时更新本政策。重大变更将通过电子邮件通知订阅者。变更后继续使用服务即表示接受新政策。"
        },
        {
          heading: "10. 联系我们",
          body: "关于隐私相关问题、数据删除请求或疑虑：\n\n电子邮件：opencard@opencardai.com\n网站：https://opencardai.com"
        }
      ]
    },
    es: {
