  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-auto">
        <a
          href={`/${lang}/my-cards`}
          className="h-12 px-5 rounded-full shadow-lg bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-300 text-slate-700 shadow-md hover:shadow-lg hover:border-blue-400 transition-all hover:scale-105 active:scale-95 flex items-center gap-2 min-w-[140px] justify-center"
        >
